...
#      raise (ZeroDivisionError("CANNOT CALCULATE PERCENTAGE WITH ZERO AS DENOMINATOR."))
#    'raise is for errors'
#
...
#
# print(get_last(list))
# print(dir(list_last_in_list))

'''I now want to make it so that its more "user input" integrated'''


#
# input_list = list(input("insert numbers or letters seperated by ',': " ))
#
# space_input_list = list(input_list)

# def get_last(space_input_list):
#    return space_input_list [-1]
#
# print(get_last(space_input_list))
